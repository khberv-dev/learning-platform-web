...
export async function createTask(courseId, unitId, lessonId, data) {
    const res = await api.post(`courses/${courseId}/units/${unitId}/lessons/${lessonId}/tasks`, data)
    return res.data
}

export async function updateTask(courseId, unitId, lessonId, taskId, data) {
    const res = await api.patch(`courses/${courseId}/units/${unitId}/lessons/${lessonId}/tasks/${taskId}`, data)
    return res.data
}

export async function deleteTask(courseId, unitId, lessonId, taskId) {
    const res = await api.delete(`courses/${courseId}/units/${unitId}/lessons/${lessonId}/tasks/${taskId}`)
    return res.data
}
